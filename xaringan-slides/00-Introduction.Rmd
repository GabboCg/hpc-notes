---
title: "Rcpp"
subtitle: "Integrando C++ con R"
author: "Gabriel Cabrera"
date: "2018/12/31 <br/> updated (`r Sys.Date()`)"
output:
  xaringan::moon_reader:
    lib_dir: libs
    css: ["default","fonts/dharma-fonts.css","fonts/dharma-theme.css"] 
    yolo: false
    nature:
...
<a style="color:#fff;" href="mailto:gcabrerag@gmail.com"><i class="fa fa-paper-plane fa-fw"></i>&nbsp; gcabrerag@gmail.com</a><br>
<a style="color:#fff;" href="https://gcabrerag.rbind.io/"><i class="fa fa-link fa-fw"></i>&nbsp; gcabrerag.rbind.io</a><br>
<a style="color:#fff;" href="https://twitter.com/GaboC_g"><i class="fa fa-twitter fa-fw"></i>&nbsp; @GaboC_g</a><br>
<a style="color:#fff;" href="http://github.com/GaboC_g"><i class="fa fa-github fa-fw"></i>&nbsp; @GaboCg</a><br>
<a style="color:#fff;" href="http://pregrado.fen.uchile.cl/"><i class="fa fa-map-marker fa-fw"></i>&nbsp; Facultad de Economía & Negocios, Universidad de Chile </a>
...
<p align="right"> Robert Heinlein <i>, The Moon is a Harsh Mistress </i> (1966).</p>
...
---
## CppCon 2015: “Rcpp: Seamless R and C++ Integration"

<br>
<br>

<center>
<iframe width="560" height="315" src="https://www.youtube.com/embed/xiqYaHa2x4s" frameborder="0" allow="encrypted-media" allowfullscreen ></iframe>
</center>
...
<center>
<iframe width="560" height="315" src="https://www.youtube.com/embed/UZkaZhsOfT4" frameborder="0" allow="encrypted-media" allowfullscreen ></iframe>
</center>

---
# Enlaces

1. https://www.rstudio.com/resources/videos/extending-r-with-c-a-brief-introduction-to-rcpp/
2. http://adv-r.had.co.nz/Rcpp.html#rcpp-intro
...
Slides creadas usando R package [**xaringan**](https://github.com/yihui/xaringan).

Los chakras provienen de [**remark.js**](https://remarkjs.com), 
[**knitr**](http://yihui.name/knitr), y [**R Markdown**](https://rmarkdown.rstudio.com).

Finalmente, el tema usado es Dharma creado por mí `r emo::ji("v")` 